...
public class Reporter {
     ...
     * Author Name: Sharmila,Pragna,Ramavathar,Venkat,Anjani.
     * Description: This method captures a screenshot of the current browser view and saves it to the designated directorywith a timestamped filename. It ensures the 'reports' folder exists and handles file operations efficiently.
     * Return Type: String (Relative path of the saved screenshot file)
     * Parameter List: String filename
     */
     ...
     * Return Type: void
     * Parameter List: String filename, ExtentTest test, String description,
     * WebDriver driver
     */
