...
public class CambioActions {
    ...
    public void clickOnCambio(ExtentTest test) {
        try {
            ...
            Reporter.addScreenshot("Cambio", test, "Cambio click Failed" );
    ...
    public void switchCambio(ExtentTest test) {
        try {
            ...
            Reporter.addScreenshot("Switch window", test, "Window switch Failed" );
    ...
    public void verifyUrl(ExtentTest test) {
        try {
            ...
            Reporter.addScreenshot("Veirfy url failed", test, "Verify url Failed" );
    ...
    public void hoverOverBikes(ExtentTest test) {
        try {
            ...
            Reporter.addScreenshot("Bikes hover", test, "Bikes hover Failed" );
    ...
    public void clickOnBestSellers(ExtentTest test) {
        try {
            ...
            Reporter.addScreenshot("Clicked Best Sellers", test, "Clicked Best Sellers Failed" );
    ...
    public void verifyProductCategories(ExtentTest test) {
        try {
            ...
            Reporter.addScreenshot("Product Categories verification failed", test,
                    "Product Categories verification Failed" );
    ...
    public void verifyBestSellingBicycle(ExtentTest test) {
        try {
            ...
            Reporter.addScreenshot("Best Selling Bicycle verification failed", test,
                    "Best Selling Bicycle verification Failed" );
    ...
    public void clickOn26T(ExtentTest test) {
        try {
            ...
            Reporter.addScreenshot("Click on 26T", test, "Click on 26T Failed" );
    ...
    public void hoverOverFirstProduct(ExtentTest test) {
        try {
            ...
            Reporter.addScreenshot("Click on First Product", test, "Click on First Product failed" );
    ...
    public void clickOnSelectOptions(ExtentTest test) {
        try {
            ...
            Reporter.addScreenshot("Click on Select Options", test, "Click on Select Options failed" );
    ...
    public void verifyTitle26T(ExtentTest test) {
        try {
            ...
            Reporter.addScreenshot("26T verification failed", test, "26T verification Failed" );
    ...
    public void clickOnAddToCart(ExtentTest test) {
        try {
            ...
            Reporter.addScreenshot("Click on Add to Cart", test, "Click on Add to Cart failed" );
    ...
    public void clickOnViewCart(ExtentTest test) {
        try {
            ...
            Reporter.addScreenshot("Click on View Cart", test, "Click on View Cart failed" );
    ...
    public void verifyCartTotals(ExtentTest test) {
        try {
            ...
            Reporter.addScreenshot("Cart totals verification failed", test, "Cart Totals verification Failed" );
    ...
    public void verifyFixedDeposit(ExtentTest test) {
        try {
            ...
            Reporter.addScreenshot("Fixed Deposit verification failed", test, "Fixed deposit verification Failed" );
