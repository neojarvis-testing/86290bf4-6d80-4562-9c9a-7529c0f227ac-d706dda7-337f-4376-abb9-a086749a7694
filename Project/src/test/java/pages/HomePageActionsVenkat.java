...
public class HomePageActionsVenkat {
     ...
     */
    public void verifyAvon(String str){
        try {
            assertion.verifyText(HomePageLocatorsVenkat.avonVerify, str);
    ...
    public void clickOnDelete(){
        try {
            ...
            Reporter.addScreenshot("Delete", test, "Delete button click Failed");
    ...
    public void dismissAlert(){
        try {
            ...
            loggerHandler.logError("Alert dismissal failed");
    ...
    public void verifyUrl(String str){
        try {
            ...
            Reporter.addScreenshot("Checkout page", test, "Checkout Page Failed to load");
     ...
     * Parameter List: String str
     */
    public void verifySelectAddress(String str){
        try {
            assertion.verifyText(HomePageLocatorsVenkat.selectAddress, str);
            ...
            Reporter.addScreenshot("Unable to verify select Address", test, "Unable to verify select Address");
     ...
     * Parameter List: String str
     */
    public void verifyPriceDetail(String str){
        try {
            assertion.verifyText(HomePageLocatorsVenkat.priceDetail, str);
            ...
            Reporter.addScreenshot("Unable to verify Price Detail", test, "Unable to verify select Address");
     ...
     * Parameter List: String str
     */
    public void verifySelectPaymentMethod(String str){
        try {
            assertion.verifyText(HomePageLocatorsVenkat.selectPaymentMethod, str);
            ...
            Reporter.addScreenshot("Unable to select Payment Method", test, "Unable to verify select Payment Method");
     ...
     * Parameter List: String str
     */
    public void verifyBackToCart(String str){
        try {
            assertion.verifyText(HomePageLocatorsVenkat.backToCart, str);
            ...
            Reporter.addScreenshot("Unable to verify Back to Cart", test, "Unable to verify Back to Cart");
